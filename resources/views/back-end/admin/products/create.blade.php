                    ...
                    <div class="innerLR">
                        <form method="POST" accept-charset="UTF-8" name="formProduct" ng-init="productItem={{$product}};categorySelected={{$categorySelected}}">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="">
                                    <select class="form-control" ng-model="productItem.type" ng-init="productItem.type='tattoo'">
                            ...
                            <div class="form-group" ng-class="{true: 'has-error'}[submitted && requiredDescription]">
                                ...
                                <div class="">
                                    <textarea class="form-control" rows="5" id="description" name="description" placeholder="Mô tả" ng-model="productItem.description">
                                    </textarea>
